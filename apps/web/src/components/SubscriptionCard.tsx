...
export function SubscriptionCard({ mentraUserId }: { mentraUserId: string }) {
	// @ts-expect-error - listAllProducts is dynamically generated by polar.api()
	const products = useQuery(api.payments.listAllProducts);
	...
	// @ts-expect-error - generateCheckoutLink is dynamically generated by polar.api()
							...
							<CustomerPortalLink
								polarApi={{
									generateCustomerPortalUrl:
										// @ts-expect-error - generateCustomerPortalUrl is dynamically generated by polar.api()
